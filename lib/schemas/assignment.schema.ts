...
export const productAssignmentSchema = z.object({
  ...
  minimumAmountType: z.nativeEnum(AmountType).nullable().optional(),
  expenditure: z.boolean().default(false),
  expenditureCost: z.number().min(0).nullable().optional(),
  expenditurePrice: z.number().min(0).nullable().optional(),
  expenditureAmount: z.number().min(0).nullable().optional(),
  expenditureAmountType: z.nativeEnum(AmountType).nullable().optional(),
